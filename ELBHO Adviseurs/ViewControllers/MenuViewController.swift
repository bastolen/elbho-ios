...
class MenuViewController: UIViewController {
    ...
    let menuItems: [MenuItem] = [
        MenuItem(text: "menu_open".localize, viewControllerIdentifier: "AppointmentViewController", storyboardIdentifier: "Appointment", id: 0),
        MenuItem(text: "menu_accepted".localize, viewControllerIdentifier: "AppointmentViewController", storyboardIdentifier: "Appointment", id: 1),
        MenuItem(text: "menu_done".localize, viewControllerIdentifier: "AppointmentViewController", storyboardIdentifier: "Appointment", id: 2),
